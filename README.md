...
#### NOTE: Any existing files should be moved to the /opt/gunbot_backup folder and numbered accordingly.. Just in case you want to reference your old settings.. Just so you know they didn't get clobbered into oblivion!
...
```
cd /opt/gunbot; wget https://github.com/RchGrav/GunBotScripts/archive/master.zip -O wgstemp.zip; unzip -qq wgstemp.zip; mv GunBotScripts-master/scripts/* .; rm -rf GunBotScripts-master; rm wgstemp.zip
```
